  ...
  return {
    ...
    analysis_patch: {
      ...
      understanding_assessment: {
        ...
        understanding_status: 'sufficient_for_first_guidance',
        confidence: 0.76,
        missing_information_priority: ['project_operating_model'],
        ready_for: {
          clarification: true,
          brain_dump: true,
        ...
        reason: 'La réponse à la première question donne un cadrage suffisant pour commencer à aider, mais pas encore assez pour générer une roadmap pertinente.',
      },
      project_name: null,
